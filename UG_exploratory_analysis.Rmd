...
Use `cumsum` example [here](https://stackoverflow.com/questions/66105937/time-series-cumulative-data-plots-using-ggplot2)
...
* ALT: ggridges of green_size by borough
* OTHER?
