...
We ultimately end with the Results, Discussion, and Conclusion of this Project's **Full Model**.
...
In this section, we investigated if there is an association with urban green space and daytime surface temperature/heat vulnerability index. We performed univariate regression analyses to understand whether the total number of urban green space influences either the average daytime surface temperature or the average heat vulnerability index score.
...
```
There does not seem to be a relationship between the total area of green roof and average daytime summer surface temperature.
...
While this analysis did not find an association between the amount of urban green spaces present and daytime surface temperature or the amount of urban green spaces present and heat vulnerability index, we believe this can be caused by weaknesses in the data available to us. More specifically:

1.    The temperature dataset and the primary dataset are not collected from the same location. It may be interesting to explore the association of green space are and temperature predictors from data that were collected at the same coordinate. This may give a better understanding of the impact of green space area and at risk neighborhoods. 

2.    The datasets vary in the date of collection. Unlike the UGS data, the daytime surface temperature data was collected on a single day and the heat vulnerability index data was collected across a few years. 

Ultimately, we believe it is important to keep exploring the impact on urban green spaces, especially as a means to fight climate change!
