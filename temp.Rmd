...
### Univariate Models to Explore the Effect of Total Urban Green Spaces in NYC
...
envo_greenroof_surfmodel %>% 
  knitr::kable(digits = 8, align = "lcccc", caption = "Table 6: Coefficient Estimates of Linear Model Assessing the Association Between Total Green Roof Surface Area and Average Daytime Surface Temperature", col.names = c("Term", "Estimate", "p-value", "Lower Confidence Interval", "Upper Confidence Interval"))
```
There does not seem to be a relationship between the total area of green roof and average daytime surface temperature. 
...
envo_greenroof_heatmodel %>% 
  knitr::kable(digits = 8, align = "lcccc", caption = "Table 7: Coefficient Estimates of Linear Model Assessing the Association Between Total Green Roof Surface Area and Average Heat Vulnerability Index", col.names = c("Term", "Estimate", "p-value", "Lower Confidence Interval", "Upper Confidence Interval"))
```
There does not seem to be a relationship between the total area of green roof and average heat vulnerability index. 

# Conclusion and Limitations

Although this analysis did not find an association between the amount of urban green spaces present and daytime surface temperature or the amount of urban green spaces present and heat vulnerability index, there still seems to be an effect of urban green spaces on air temperature in the 5 boroughs of New York City. Urban green spaces have been found to be effective in bringing down temperatures in neighborhood that lack green spaces, such as the Bronx. It is important to keep exploring the impact on urban green spaces, especially as a means to fight climate change!
